...
const Marketing = () => {
  ...
  const visibleCountries = showAllCountries
    ? countries
    : countries.slice(0, INITIAL_COUNTRIES_SHOWN);
    ...
    <div className="w-full overflow-x-hidden text-navy-ink bg-sand">
      ...
      <section className="w-[90%] max-w-[1240px] mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-[60px] px-4 lg:px-5 pt-[30px] pb-[60px] lg:pt-[50px] lg:pb-[100px]">
        <div className="lg:flex-[1.15]">
          ...
          <h1 className="font-sora text-[28px] lg:text-[48px] font-extrabold leading-[1.15] text-navy mb-[22px]">
            Buy, sell &amp; discover <span className="text-accent">anything</span>,
            anytime.
          </h1>

          <p className="text-base lg:text-lg text-muted max-w-[520px] mb-[34px] leading-[1.6]">
            Cars, phones, apartments, jobs and more — post an ad in minutes,
            or browse thousands of listings near you. No middlemen, no
            waiting rooms, just people trading directly.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 mb-[50px]">
            <Link to="/app" className={btnPrimary}>
              Start Exploring <HiOutlineArrowRight />
            </Link>
            <Link to="/app/create-ad" className={btnSecondary}>
              Post an Ad
            </Link>
          </div>
          ...
          <div className="flex gap-[22px] lg:gap-9 flex-wrap">
            {STATS.map((s) => (
              <div className="flex flex-col" key={s.label}>
                <strong className="font-sora text-[26px] font-extrabold text-navy">
                  {s.value}
                </strong>
      ...
      <section className="w-[90%] max-w-[1240px] mx-auto flex flex-col lg:flex-row items-center text-center lg:text-left gap-10 lg:gap-[70px] px-4 lg:px-5 pt-[30px] lg:pt-10 pb-[70px] lg:pb-[110px]">
        ...
        <div>
          ...
          <p className="text-muted text-base leading-[1.7] mb-4 max-w-[620px] mx-auto lg:mx-0">
            247Market started with a simple observation: great deals don't
            keep office hours. Whether it's a car listed at midnight or an
            apartment someone finds at dawn, the best marketplaces are the
            ones that are always open — for everyone, in every city.
          </p>
          <p className="text-muted text-base leading-[1.7] mb-4 max-w-[620px] mx-auto lg:mx-0">
            We built 247Market to bring Nigeria's informal buying and
            selling online, with the trust and structure it deserves:
            verified accounts, transparent listings, and soon, a built-in
            wallet so you can fund your account and pay for what you want
      ...
      <section className="w-[90%] max-w-[1240px] mx-auto px-4 lg:px-5 pt-10 pb-[70px] lg:pb-[110px] text-center">
        <div className={sectionHeading}>
          ...
          <p className="mt-3 text-muted text-[15px] leading-[1.6]">
            247Market is live across Africa. Pick a country to see local
            listings, popular categories and top cities.
          </p>
        </div>
      ...
      <section className="w-[90%] max-w-[1240px] mx-auto px-4 lg:px-5 pt-10 pb-[70px] lg:pb-[110px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white border border-[#e7e2d8] rounded-2xl px-6 py-[30px] text-left transition-[0.25s] hover:-translate-y-1 hover:shadow-[0_20px_34px_-18px_rgba(7,19,40,0.25)] hover:border-transparent">
            ...
            <p className="text-sm text-muted leading-[1.6]">
              Post an ad or find a deal in minutes, not hours.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-[90%] max-w-[1240px] mx-auto px-4 lg:px-5 pt-10 pb-[70px] lg:pb-[110px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-[30px]">
          {STEPS.map((step) => (
            <div
              className="bg-white border border-[#e7e2d8] rounded-2xl px-7 py-[34px] relative"
              key={step.n}
            >
      ...
      <section className="w-[90%] max-w-[640px] mx-auto px-4 lg:px-5 pt-10 pb-[70px] lg:pb-[110px] text-center">
        <RiChat3Line className="text-[34px] text-accent bg-accent-soft p-3.5 rounded-2xl mb-5 inline-block" />
        <h2 className="text-[28px] text-navy mb-3 font-extrabold">Stay in the loop</h2>
        <p className="text-muted mb-[26px] text-[15px]">
          Get the best new listings and 247Market updates straight to your
      ...
      <section className="bg-[linear-gradient(135deg,#0d2140_0%,#071328_100%)] text-white text-center px-4 lg:px-5 py-[60px] lg:py-[90px]">
        ...
        <p className="text-base opacity-85 mb-[30px]">
          Join 247Market and turn your listings into sales today.
        </p>
        <Link
          to="/app"
      ...
      <footer
        id="footer"
        className="bg-navy-deep text-white/85 px-4 lg:px-5 pt-[50px] lg:pt-[70px] pb-[30px]"
      >
        <div className="w-[90%] max-w-[1240px] mx-auto flex flex-col lg:flex-row justify-between gap-9 lg:gap-[60px] pb-[50px] flex-wrap">
          <div>
            ...
            <p className="text-white/55 text-sm max-w-[260px]">
              Nigeria's marketplace, open around the clock.
            </p>
          </div>
          ...
          <div className="flex gap-9 sm:gap-[70px] flex-wrap">
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/app" className="text-white/60 text-sm transition-[0.2s] hover:text-accent-soft">
                Home
              </Link>
              <Link to="/app/discover" className="text-white/60 text-sm transition-[0.2s] hover:text-accent-soft">
                Discover
              </Link>
              <Link to="/app/categories" className="text-white/60 text-sm transition-[0.2s] hover:text-accent-soft">
                Categories
              </Link>
              <Link to="/app/create-ad" className="text-white/60 text-sm transition-[0.2s] hover:text-accent-soft">
                Post an Ad
              </Link>
            </div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a href="#footer" className="text-white/60 text-sm transition-[0.2s] hover:text-accent-soft">
                About Us
              </a>
              <a href="#footer" className="text-white/60 text-sm transition-[0.2s] hover:text-accent-soft">
                Contact
